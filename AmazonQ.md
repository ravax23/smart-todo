...
### 1.0 ブランチ操作の基本ルール
- **重要** Amazon Q Developer が作業を行うときは以下を意識して対応する
- 原則としてローカルリポジトリのブランチで作業を行うこと
- 指示がない限り、作業ブランチを作成しないこと
- 指示がない限り、作業ブランチでの変更をmainブランチへマージしないこと
- 指示がない限り、リモートリポジトリへプッシュしないこと
- Issueの作業を開始する指示があった場合に、作業ブランチを作成すること
- 作業ブランチでの作業が完了しmainブランチへのマージの指示があった場合に、ローカルリポジトリのmainブランチへマージし、その後リモートリポジトリへプッシュする こと
- マージが完了したことを確認した後、関連するIssueをクローズすること
- 作業が終わった作業ブランチはアーカイブして履歴として残すこと（アーカイブはリモートリポジトリでも残しておくこと）
